    ...
    try {
      ...
      setSuccessMessage(
        result.status === 'approved' 
          ...
          : "Reserva criada com sucesso! Aguardando aprovação do administrador."
      );
      ...
      <div className="p-8">
        ...
        <div className="mb-6">
          ...
          <p className="text-gray-700">
            Criar uma nova reserva de sala (será enviada para aprovação)
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
          ...
          <div className="bg-white rounded-lg shadow border p-4 max-h-[calc(100vh-12rem)] overflow-y-auto form-scroll form-container">
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              {/* Preview da Reserva */}
              {formData.room_id && formData.title && formData.start_date && formData.start_time && formData.end_date && formData.end_time && (
                <div className="border-t pt-4">
                  ...
                  <div className="bg-gray-50 p-3 rounded-lg">
                    <div className="grid grid-cols-1 gap-2 text-sm">
                      ...
                      <div>
                        <strong>Sala:</strong> {rooms.find(r => r.id === parseInt(formData.room_id))?.name} - {rooms.find(r => r.id === parseInt(formData.room_id))?.location}
                      </div>
                      <div>
